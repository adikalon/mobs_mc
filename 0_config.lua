...
mobs_mc.spawns = {
	axolotl = {
		...
		neighbors = mobs_mc.spawn_nodes.axolotl,
		min_light = 0,
		interval = 60,
		chance = 5000,
	...
	guardian = {
		...
		neighbors = mobs_mc.spawn_nodes.guardian,
		min_light = 0,
		interval = 60,
		chance = 20000,
		active_object_count = 1,
	...
	guardian_elder = {
		...
		neighbors = mobs_mc.spawn_nodes.guardian_elder,
		min_light = 14,
		interval = 0,
		chance = 20000,
		active_object_count = 1,
	...
	squid = {
		...
		neighbors = mobs_mc.spawn_nodes.squid,
		min_light = 0,
		interval = 60,
		chance = 5000,
		active_object_count = 1,
